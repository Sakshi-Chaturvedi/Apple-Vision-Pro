...
tl3.to("#page-04 .page-04-content", {
  top: "-50%",
});

// ! ------------ Canvas Code ---------------------
function canvas() {
  const canvas = document.querySelector("#page-07>canvas");
...
let tl4 = gsap.timeline({
  scrollTrigger: {
    trigger: "#page-21",
    scroller: "#main", // Ensure this is the correct scroller ID
    // markers: true, // For debugging
    start: "top 10%", // Adjust the start position as needed
    end: "top 11%", // Set a valid end position
    scrub: 2,
  },
});
...
tl4.to("#etracoff", {
  opacity: 0,
  duration: 1, // Optional: Adds animation duration for better control
});

function replayBtn() {
  let replayButton = document.querySelector("#page-22 h4");

  replayButton.addEventListener("click", () => {
    let tl5 = gsap.timeline();
    tl5.to("#page-22 .images-box #img-06", {
      opacity: 0,
      duration: 1, // Add duration for a smooth transition
    });
    tl5.to("#page-22 .images-box #img-05", {
      opacity: 0,
      duration: 1, // Add duration for a smooth transition
    });
    tl5.to("#page-22 .images-box #img-04", {
      opacity: 0,
      duration: 1, // Add duration for a smooth transition
    });
    tl5.to("#page-22 .images-box #img-03", {
      opacity: 0,
      duration: 1, // Add duration for a smooth transition
    });
    tl5.to("#page-22 .images-box #img-02", {
      opacity: 0,
      duration: 1, // Add duration for a smooth transition
    });
    // tl5.to("#page-22 .images-box #img-01", {
    //   opacity: 0,
    //   duration: 1, // Add duration for a smooth transition
    // });
    tl5.to("#page-22 .images-box #img-06", {
